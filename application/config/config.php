...
if ($is_local) {
    // For local development, ensure we have the correct path
...
// Set session save path with fallback options
$session_path = NULL;

// Try system temp directory first
$temp_path = sys_get_temp_dir() . '/ci_sessions/';
...
// If temp directory doesn't work, try application cache directory
if ($session_path === NULL) {
    $cache_path = FCPATH . 'application/cache/sessions/';
...
// If all else fails, use NULL to let PHP handle it
