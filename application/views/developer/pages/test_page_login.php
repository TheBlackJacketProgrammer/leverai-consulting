    ...
    <body ng-app="ng-bcms-app" ng-controller="ng-variables">
        ...
        <?php $this->load->view('components/header'); ?>
         ...
         <main class="test-login">
            <section class="full-bleed" ng-controller="ng-login">
                <div class="flex flex-col items-center justify-center">
                    <div class="login-container">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-1 gap-4 mt-4">
                            ...
                            <input type="button" value="Login" class="btn-primary mt-4 mx-auto">
                            <div class="submit-divider">
                                <div class="divider"></div><span>OR</span><div class="divider"></div>
                            </div>
                            <span class="text-white">Don't have an account? <a href="<?php echo base_url('login'); ?>" class="ml-2 primary">Sign Up Now</a></span>
                        </div>
        </main>
