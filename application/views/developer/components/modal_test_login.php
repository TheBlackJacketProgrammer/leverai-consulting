<div id="modal_testLogin" class="modal hidden">
    <!-- Modal Dialog Box -->
    <div class="modal-dialog-box">
        <!-- Header -->
        <div class="modal-header">
            <h5 class="text-black">Account Test Login</h5>
            <button id="closeModal" ng-click="closeModal('modal_testLogin')" class="btn-close">
                <b>x</b>
            </button>
        </div>
        <!-- Body-->
        <div class="modal-body">
            ...
            <div class="input-wrapper mb-2">
                ...
                <input id="email" type="text" placeholder="Email*" ng-model="credentials.email" required>
            </div>
            <!-- Password -->
            <div class="input-wrapper mb-2">
                <svg class="input-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <input id="password" type="password" placeholder="Password*" ng-model="credentials.password" required>
            </div> 
            <!-- Login Button -->
            <div class="divider"></div>
            <button class="btn-primary" ng-click="testLogin()">Login</button>
        </div>
    </div>
</div>